...
Date: 2/28/2020
Course: CIS 400
Assignment 2: Scraping Twitter's API to create a map of friends
"""
...
def oauth_login():
    ...
    auth = twitter.oauth.OAuth(config.access_token, config.token_secret, config.api_key, config.api_secret)
