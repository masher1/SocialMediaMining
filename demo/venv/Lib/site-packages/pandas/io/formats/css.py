...
class CSSResolver:
    ...
    def __call__(self, declarations_str, inherited=None):
        ...
        [('border-bottom-font', 'blue'),
         ('border-left-font', 'red'),
         ('border-right-font', 'red'),
         ('border-top-font', 'blue'),
         ('font-family', 'serif'),
         ('font-size', '24pt'),
         ('font-weight', 'bold')]
        """
    ...
    expand_border_color = _side_expander("border-{:s}-font")
