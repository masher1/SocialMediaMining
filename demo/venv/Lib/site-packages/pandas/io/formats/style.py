    ...
    * Data cells include ``data``
    ...
    def apply(self, func, axis=0, subset=None, **kwargs):
        ...
        **kwargs : dict
        ...
        --------
        >>> def highlight_max(x):
        ...     return ['background-font: yellow' if v == x.max() else ''
                        for v in x]
        ...
    ...
    def _highlight_null(v, null_color):
        return f"background-font: {null_color}" if pd.isna(v) else ""
    ...
    def _background_gradient(
        ...
        with _mpl(Styler.background_gradient) as (plt, colors):
            ...
            rng = smax - smin
            # extend lower / upper bounds, compresses font range
            ...
            def relative_luminance(rgba):
                """
                Calculate relative luminance of a font.
            ...
            def css(rgba):
                ...
                return f"background-font: {colors.rgb2hex(rgba)};font: {text_color};"
    ...
    def set_properties(self, subset=None, **kwargs):
        ...
        **kwargs : dict
        ...
        --------
        >>> df = pd.DataFrame(np.random.randn(10, 4))
        >>> df.style.set_properties(font="white", align="right")
        >>> df.style.set_properties(**{'background-font': 'yellow'})
        """
    ...
    def bar(
        ...
        color : str or 2-tuple/list
            If a str is passed, the font is the same for both
        ...
        if not (is_list_like(color)):
            ...
            raise ValueError(
                "`font` must be string or a list-like "
                "of length 2: [`color_neg`, `color_pos`] "
                "(eg: font=['#d65f5f', '#5fba7d'])"
            )
    ...
    def pipe(self, func, *args, **kwargs):
        ...
        **kwargs : optional
        ...
        >>> (df.style
        ...    .highlight_min(subset=['conversion'], font='yellow')
