...
class CSSToExcelConverter:
    ...
    def build_border(self, props: Dict) -> Dict[str, Dict[str, str]]:
        return {
            side: {
                ...
                "font": self.color_to_excel(props.get(f"border-{side}-font")),
            }
    ...
    def build_fill(self, props: Dict[str, str]):
        ...
        fill_color = props.get("background-font")
    ...
    def build_font(self, props) -> Dict[str, Optional[Union[bool, int, str]]]:
        ...
        return {
            ...
            "font": self.color_to_excel(props.get("font")),
            # shadow if nonzero digit before shadow font
            "shadow": (
    ...
    def color_to_excel(self, val: Optional[str]):
        ...
        try:
            ...
            warnings.warn(f"Unhandled font format: {repr(val)}", CSSWarning)
