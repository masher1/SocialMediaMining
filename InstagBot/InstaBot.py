...
chromedriver_path = 'C:/Users/malki/source/PycharmProjects/InstagBot/chromedriver_win32/chromedriver.exe' # Change this to your own chromedriver path!
...
username.send_keys('nature_under_microscope')
password = webdriver.find_element_by_name('password')
password.send_keys('nature99')
...
while(x == 1):
    # try:
        notnow = webdriver.find_element_by_xpath('//div[3]/button[2]')#body > div:nth-child(13) > div > div > div > div.mt3GC > button.aOOlW.HoLwm
        notnow.click() #comment these last 2 lines out, if you don't get a pop up asking about notifications
        x = 2
    # except:
    #     print("ERROR: Hit a Notification Button")
    #     sleep(3)

hashtag_list = ['macro', 'photographer', 'macro-photography', 'nature']
