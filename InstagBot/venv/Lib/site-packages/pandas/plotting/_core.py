    ...
    **kwargs
    ...
    def bar(self, x=None, y=None, **kwargs):
        ...
        **kwargs
        ...
        distinct font, and each row is nested in a group along the
        horizontal axis.
    ...
    def scatter(self, x, y, s=None, c=None, **kwargs):
        """
        Create a scatter plot with varying marker point size and font.
        ...
        c : str, int or array_like, optional
            The font of each point. Possible values are:

            - A single font string referred to by name, RGB or RGBA code,
              for instance 'red' or '#a98d19'.

            - A sequence of font strings referred to by name, RGB or RGBA
              code, which will be used for each point's font recursively. For
              instance ['green','yellow'] all points will be filled in green or
              yellow, alternatively.

            - A column name or position whose values will be used to font the
        ...
        **kwargs
        ...
        And now with the font determined by a column as well.
