...
def test_write_cells_merge_styled(ext):
    ...
    sty_b1 = {"font": {"font": "00FF0000"}}
    sty_a2 = {"font": {"font": "0000FF00"}}
    ...
    sty_merged = {"font": {"font": "000000FF", "bold": True}}
...
def test_to_excel_with_openpyxl_engine(ext, tmpdir):
    ...
    styled = df.style.applymap(
        lambda val: "font: %s" % "red" if val < 0 else "black"
    ).highlight_max()
